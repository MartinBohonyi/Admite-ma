...
.then(async exameneData => {
    ...
    function showQuestion(index) {
        ...
        const question =
            ...
            console.log(
    "IMAGINE:",
    `${questionData.basePath}images/Q${question.questionNumber}.png`
);
        ...
        if (question.questionContextImage) {

            const contextImage =
                document.createElement("img");

            contextImage.classList.add(
                "question-context-image"
            );

            contextImage.src =
                question.questionContextImage;
...
const imageNumber =
    String(question.questionNumber).replace(/\.$/, "");

questionImage.src =
    `${questionData.basePath}images/Q${imageNumber}.png`;
