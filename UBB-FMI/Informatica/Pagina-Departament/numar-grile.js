const examene = [
    ...
    "../Grile-Capitole/Recursivitate/exam.json",
    "../Grile-Capitole/Complexitate/exam.json",
    "../Grile-Capitole/Combinatorica/exam.json",
    "../Grile-Capitole/Grafuri/exam.json",
];
